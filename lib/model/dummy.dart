...
//
//     final dumy = dumyFromJson(jsonString);

import 'dart:convert';

Dumy dumyFromJson(String str) => Dumy.fromJson(json.decode(str));

String dumyToJson(Dumy data) => json.encode(data.toJson());
...
class Dumy {
    ...
    factory Dumy.fromJson(Map<String, dynamic> json) => Dumy(
